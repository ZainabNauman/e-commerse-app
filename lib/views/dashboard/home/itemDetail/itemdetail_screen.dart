        ...
        children: [
          ...
          Expanded(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Padding(
                  padding: EdgeInsets.only(left:size.width*0.04,bottom: size.width*0.01),
                  child: Text(item.name,style: TextStyle(fontSize:size.width*0.03,fontFamily:StringConstant.font,fontWeight: FontWeight.bold))),
                Padding(
                  padding: EdgeInsets.only(left:size.width*0.04,bottom: size.width*0.01,right: size.width*0.04),
                  child: Row(children: [ Text(item.price,style: TextStyle(fontSize: size.width*0.04 ,fontFamily:StringConstant.font,fontWeight: FontWeight.bold)),
                ...
                Padding(
                  padding: EdgeInsets.only(left: size.width*0.04,bottom: size.width*0.02),
                  child: Text("Description",textAlign: TextAlign.center,style: TextStyle(fontSize: size.width*0.026 ,fontFamily:StringConstant.font,fontWeight: FontWeight.bold)),
                ),
                Padding(
                  padding: EdgeInsets.only(left: size.width*0.04,bottom: size.width*0.02,right: size.width*0.04),
                  child: Text(StringConstant.dummyString,style: TextStyle(fontSize: size.width*0.025 ,fontFamily:StringConstant.font,fontWeight: FontWeight.normal)),
                ),
                SizedBox(width: size.width*0.04),
                Padding(
                  padding: EdgeInsets.only(left:size.width*0.04,bottom: size.width*0.04,right: size.width*0.04,top: size.width*0.02),
                  child: Row(crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
